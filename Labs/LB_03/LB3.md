...
### 2.5. Робота з командами довідки (Main Pages) в терміналі
...
Різниця полягає в рівні прав доступу в системі.
Якщо в кінці командного запрошення Bash відображається символ "$" (наприклад, [centos@localhost Desktop]$), це означає, що працює звичайний користувач із обмеженими правами.
Якщо ж у кінці рядка стоїть символ "#" (наприклад, [root@localhost Desktop]#), це свідчить про те, що сеанс відкрито від імені суперкористувача root, який має повні адміністративні повноваження та може змінювати системні файли й налаштування.
