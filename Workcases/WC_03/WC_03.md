...
<h1 align="center">КІНЬ В МІКРОВОНОВЦІ!!!</h1>

<p align="center">
  <img src="img/tomascore-microwave.gif">
</p>

# Consulation

In this practical work, the processes of cloning, exporting, and configuring network interaction between virtual machines were studied using Oracle VM VirtualBox. A virtual machine was successfully cloned, exported in the .ova format, and connected to the network using the Bridged Adapter mode.

Network connectivity between the original and cloned machines was verified using tools such as ping and netcat, and file sharing was configured using Samba and shared folders. As a result, practical skills in virtualization, network configuration, and file exchange between systems were developed.
